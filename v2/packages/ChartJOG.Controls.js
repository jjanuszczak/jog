...
(() => {
  ...
  (function(global) {
    ...
    BarChart.prototype.ApplyState = function(prevState, nextState) {
      ...
      if (this._chartAdapter && (prevState.items !== nextState.items || prevState.labelField !== nextState.labelField || prevState.valueField !== nextState.valueField || prevState.seriesLabel !== nextState.seriesLabel || prevState.titleText !== nextState.titleText)) {
