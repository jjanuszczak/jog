...
---
> Generated from `doc/release-guide.md`. Edit the source file, then rerun `node jog-docs/scripts/sync-docs.mjs`.
...
When a GitHub Release is published, [.github/workflows/release-artifacts.yml](https://github.com/jjanuszczak/jog/blob/main/.github/workflows/release-artifacts.yml) builds the assets and uploads them automatically.
...
For hosted static example guidance, including CSP and recommended browser-security headers for the current Notepad example, see [notepad-hosting.md](https://github.com/jjanuszczak/jog/blob/main/doc/notepad-hosting.md).

## Documentation Site

The Docsy documentation site source now lives in `jog-docs/`.

GitHub Pages deployment is automated with [.github/workflows/docs-pages.yml](https://github.com/jjanuszczak/jog/blob/main/.github/workflows/docs-pages.yml).

That workflow currently:

1. installs the `jog-docs/` npm dependencies
2. syncs canonical repo docs into the Docsy content tree
3. builds Hugo with a repository-scoped Pages `baseURL`
...
4. [README.md]({{< relref "/docs/getting-started/overview.md" >}}), [doc/developer-guide.md]({{< relref "/docs/guides/developer-guide.md" >}}), [doc/api-reference.md]({{< relref "/docs/reference/api-reference.md" >}}), and [doc/roadmap.md]({{< relref "/docs/project/roadmap.md" >}}) reflect current implementation reality
...
7. the release notes draft in [public-preview-release-notes-draft.md](https://github.com/jjanuszczak/jog/blob/main/doc/public-preview-release-notes-draft.md) has been reviewed and adjusted for the exact release contents
...
3. confirm [CODE_OF_CONDUCT.md](https://github.com/jjanuszczak/jog/blob/main/CODE_OF_CONDUCT.md), [SECURITY.md](https://github.com/jjanuszczak/jog/blob/main/SECURITY.md), issue templates, and the pull request template are present and reflect the current maintainer workflow
...
6. review the draft text in [start-here-discussion-draft.md](https://github.com/jjanuszczak/jog/blob/main/doc/start-here-discussion-draft.md) and convert it into the first pinned discussion when the repo opens
