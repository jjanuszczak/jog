...
---
> Generated from `doc/api-reference.md`. Edit the source file, then rerun `node jog-docs/scripts/sync-docs.mjs`.

# JOG V2 API Reference

## Status

This reference covers the implemented public API in [v2/runtime/JOG.js](https://github.com/jjanuszczak/jog/blob/main/v2/runtime/JOG.js). If code and this document diverge, update this document immediately.
