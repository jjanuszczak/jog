...
---
> Generated from `doc/developer-guide.md`. Edit the source file, then rerun `node jog-docs/scripts/sync-docs.mjs`.
...
- source runtime at [v2/runtime/JOG.js](https://github.com/jjanuszczak/jog/blob/main/v2/runtime/JOG.js)
...
- the current contract is implemented in `v2/runtime/JOG.js` and exercised by [AcmeJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/AcmeJOG.Controls.js), [BeaconJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/BeaconJOG.Controls.js), [ChartJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/ChartJOG.Controls.js), [FlatpickrJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/FlatpickrJOG.Controls.js), and [LexicalJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/LexicalJOG.Controls.js)
- the broader direction and remaining gaps are documented in [third-party-control-spec.md]({{< relref "/docs/reference/third-party-controls.md" >}})
...
See [v2/apps/HelloWorldApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/HelloWorldApp.js) and [v2/examples/hello-world.html](https://github.com/jjanuszczak/jog/blob/main/v2/examples/hello-world.html).
...
The `dist/release/` files are the exact assets that should be attached to GitHub Releases today. The current release process is documented in [doc/release-guide.md]({{< relref "/docs/project/release-guide.md" >}}), and the upload step is automated in [release-artifacts.yml](https://github.com/jjanuszczak/jog/blob/main/.github/workflows/release-artifacts.yml).
...
- `AcmeJOG.InspectorCard` in [AcmeJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/AcmeJOG.Controls.js)
- `BeaconJOG.MetricCard` in [BeaconJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/BeaconJOG.Controls.js)
...
- `ChartJOG.BarChart` in [ChartJOG.Controls.source.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/ChartJOG.Controls.source.js)
- `FlatpickrJOG.DatePicker` in [FlatpickrJOG.Controls.source.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/FlatpickrJOG.Controls.source.js)
- `LexicalJOG.LexicalPlainTextBox` and `LexicalJOG.LexicalRichTextBox` in [LexicalJOG.Controls.source.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/LexicalJOG.Controls.source.js)
- shared wrapper mechanics in [ThirdPartyJOG.Helpers.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/ThirdPartyJOG.Helpers.js)
...
- `AcmeJOG.TagPicker` in [AcmeJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/AcmeJOG.Controls.js)
- `BeaconJOG.ViewSwitch` in [BeaconJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/BeaconJOG.Controls.js)
...
- [AcmeJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/AcmeJOG.Controls.js) registers `AcmeJOG.TagPicker` as a primitive control and `AcmeJOG.InspectorCard` as a composite container with a custom child host
- [AcmeJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/AcmeJOG.Controls.js) also registers `AcmeJOG.CommandPaletteDialog` as a third-party dialog that reuses the built-in window shell through `GetWindowShell()`
- [BeaconJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/BeaconJOG.Controls.js) registers `BeaconJOG.ViewSwitch` as a second primitive control and `BeaconJOG.MetricCard` as a composite control built largely from existing JOG controls
- [ChartJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/ChartJOG.Controls.js) registers `ChartJOG.BarChart` as a Chart.js wrapper with array-backed `Items`, field-based series mapping, `BindCollection()`, and projected `OnPointClick()` events
- [ChartJOG.Controls.source.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/ChartJOG.Controls.source.js) is the editable source for that bundle, and [build-chart-package.js](https://github.com/jjanuszczak/jog/blob/main/scripts/build-chart-package.js) rebuilds the browser-ready package
- [FlatpickrJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/FlatpickrJOG.Controls.js) registers `FlatpickrJOG.DatePicker` as a popup date-picker wrapper around Flatpickr, with canonical string `Value`, `MinDate`, `MaxDate`, `BindValue()`, and normal JOG validation behavior
- [FlatpickrJOG.Controls.source.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/FlatpickrJOG.Controls.source.js) is the editable source for that bundle, and [build-flatpickr-package.js](https://github.com/jjanuszczak/jog/blob/main/scripts/build-flatpickr-package.js) rebuilds the browser-ready package
- [LexicalJOG.Controls.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages/LexicalJOG.Controls.js) now registers both `LexicalJOG.LexicalPlainTextBox` and `LexicalJOG.LexicalRichTextBox`, keeping Lexical JSON as the canonical `Value`, preserving `GetPlainText()`, `SetPlainText(text)`, and `BindPlainText()` for ordinary form wiring, tracking editable-host accessibility state for read-only and invalid transitions, and treating whitespace-only content as empty for required-field validation
- [LexicalJOG.Controls.source.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/LexicalJOG.Controls.source.js) is the editable source for that bundle, and [build-lexical-package.js](https://github.com/jjanuszczak/jog/blob/main/scripts/build-lexical-package.js) rebuilds the browser-ready package
- [ThirdPartyJOG.Helpers.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/ThirdPartyJOG.Helpers.js) now holds the shared internal bridge used by the external-library wrappers for value synchronization, collection binding, store binding, and detached-popup theme-variable propagation
- [ThirdPartyDemoApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/ThirdPartyDemoApp.js) and [third-party-demo.html](https://github.com/jjanuszczak/jog/blob/main/v2/examples/third-party-demo.html) show all five packages used side by side from outside `v2/runtime/JOG.js`, including the current baseline validation pattern for third-party inputs through `BindError()`, `FormState.Watch(...)`, `ValidationSummary.BindErrors(...)`, and `Focus()` on invalid submit, plus both a `ToolBar`-based button row using the Lexical convenience methods and a plain button row calling `FormatText(formatType)` directly
...
The repo now also includes a small shared helper for this pattern in [ThirdPartyJOG.Helpers.js](https://github.com/jjanuszczak/jog/blob/main/v2/packages-src/ThirdPartyJOG.Helpers.js).
...
[v2/apps/ExampleApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/ExampleApp.js) demonstrates:
...
[v2/apps/CustomerAdminApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/CustomerAdminApp.js) demonstrates:
...
[v2/apps/FormApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/FormApp.js) demonstrates:
...
[v2/apps/CustomerAdminApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/CustomerAdminApp.js) now also demonstrates:
...
[v2/apps/ExampleApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/ExampleApp.js) now also demonstrates:
...
[v2/apps/OpportunityBoardApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/OpportunityBoardApp.js) now also demonstrates:
...
[v2/apps/NotepadApp.js](https://github.com/jjanuszczak/jog/blob/main/v2/apps/NotepadApp.js) now also demonstrates:
